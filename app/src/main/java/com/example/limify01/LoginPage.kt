...
import com.example.limify01.databinding.ActivityLoginPageBinding
                    ...
                    theBase.createUserWithEmailAndPassword(username, password)
                        .addOnCompleteListener(OnCompleteListener<AuthResult> { task ->
                            if (task.isSuccessful) {
                                ...
                                theBase.signInWithEmailAndPassword(username, password).addOnCompleteListener { mTask ->
                                    if (mTask.isSuccessful) {
                                        val intent =
                                            Intent(this, activity_login::class.java).apply {
